...
-(id)performGETRequestToHost:(NSString *)host withRelativeURL:(NSString *)relativeURL andIP:(NSString *)ipString withPort:(int)port withProperties:(NSDictionary *)properties
{
    ...
    */
    ...
    const char *ip = [ipString UTF8String];
...
-(id)performPOSTRequestToHost:(NSString *)host withRelativeURL:(NSString *)relativeURL andIP:(NSString *)ipString withPort:(int)port withProperties:(id)properties
{
    BOOL parseFailed = FALSE;
